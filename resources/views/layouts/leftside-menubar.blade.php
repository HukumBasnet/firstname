...
<ul class="nav flex-column">
  ...
  @foreach(Session::get('users') as $users)
  @if($users->name === 'Dashboard')
  <li class="nav-item active">
    <a class="nav-link" href="{{ url('home') }}"><i class="material-icons">dashboard</i> <span class="nav-link-text">@lang('Dashboard')</span></a>
  </li>
  @endif

  @if($users->name ==='Statements')
  <li class="nav-item dropdown">
    <a role="button" href="#" class="nav-link" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i
        class="material-icons">chrome_reader_mode</i> <span class="nav-link-text">@lang('Statements')</span> <i class="material-icons pull-right">keyboard_arrow_down</i></a>
    <ul class="dropdown-menu" style="width: 100%;">
      <!-- Dropdown menu links -->
      <li>
        <a class="dropdown-item" href="{{ url('statement/inquiry') }}"><i class="material-icons">developer_board</i> <span
            class="nav-link-text">@lang('Students inquiry')</span></a>
      </li> 
       <li>
        <a class="dropdown-item" href="{{ url('statement/registration') }}"><i class="material-icons">note_add</i> <span class="nav-link-text">@lang('Students registration')</span></a>
      </li>
      <li>
        <a class="dropdown-item" href="{{ url('statement/admission') }}"><i class="material-icons">note_add</i> <span class="nav-link-text">@lang('Students admission')</span></a>
      </li>
      <li>
        <a class="dropdown-item" href="{{url('statement/teacherregistration')}}"><i class="material-icons">note_add</i> <span class="nav-link-test">@lang('Teacher Registration')</span></a>
      </li>
    </ul>
  </li>
  @endif

  @if($users->name === 'Attendence')
  <li class="nav-item dropdown">
    <a role="button" href="#" class="nav-link" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i
  ...
  @endif
  @if($users->name === 'Classes & Sections')
  <li class="nav-item">
  ...
  @if($users->name === 'Teachers')
  <li class="nav-item">
    <a class="nav-link" href="{{route('statement.teacherlist')}}"><i class="material-icons">contacts</i>
  ...
  @endif
  @if($users->name === 'Academic Settings')
  <li class="nav-item">
