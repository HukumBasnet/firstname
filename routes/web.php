...
Route::get('roles/{section_id}/edit', 'RolesController@edit');

Route::patch('roles/{section_id}', 'RolesController@update');


Route::delete('roles/{section_id}', 'RolesController@destroy');



Route::get('roles/{section_id}', 'RolesController@show');
...
Route::middleware(['auth'])->prefix('grades')->group(function (){
...
Route::get('grades/{student_id}', 'GradeController@index')->middleware(['auth']);
...
Route::middleware(['auth'])->group(function (){
  if (config('app.env') != 'production') {
    Route::get('user/config/impersonate', 'UserController@impersonateGet')->name('imp');
...
Route::get('user/{id}/notifications', 'NotificationController@index')->middleware(['auth']);
...
Route::middleware(['auth'])->prefix('statement')->name('statement.')->group(function(){
  Route::get('inquiry','Statement@inquiry')->name('inquiry');
  Route::get('add_inquiry','Statement@inquiry_add');
  Route::post('save_inquiry/{id?}','Statement@inquiry_save')->name('save_inquiry');
  Route::get('edit_inquiry/{id}','Statement@inquiry_edit');
  Route::get('delete_inquiry/{id}','Statement@inquiry_delete');


  Route::get('registration','Statement@registration')->name('registration');
  Route::get('add_registration/{id}','Statement@registration_add');
  Route::get('new_registration','Statement@new_registration');
  
  Route::post('save_registration/{id?}','Statement@registration_save')->name('save_registration');
  Route::get('edit_registration/{id}','Statement@registration_edit');
  Route::get('delete_registration/{id}','Statement@registration_delete');

  Route::get('admission','Statement@admission')->name('admission');
    Route::get('admission_form/{id}','Statement@admission_form')->name('admission_form');
    Route::post('student-admission','Statement@studentadmission')->name('studentadmission');
    Route::get('deleteadmission/{id}','Statement@deleteadmission')->name('deleteadmission');

    // teacher registration
    Route::get('teacherregistration','Statement@teacherregistrationpage')->name('teacherregistrationpage');
    Route::post('teacher-registration','Statement@teacherregistration')->name('teachrregistration');
    Route::get('teacher-list','Statement@teacherlist')->name('teacherlist');
    Route::get('teacher-delete/{id}','Statement@deleteteacher')->name('deleteteacher');
    Route::get('teacher-edit-page/{id}','Statement@teachereditpage')->name('teachereditpage');
    Route::put('edit-teacher/{id}','Statement@editteacher')->name('editteacher');
});
...
Route::middleware(['auth'])->namespace('Library')->group(function () {
    Route::prefix('library')->name('library.')->group(function () {
        Route::resource('books', 'BookController');
    });
});

Route::middleware(['auth'])->prefix('library')->name('library.issued-books.')->group(function () {
